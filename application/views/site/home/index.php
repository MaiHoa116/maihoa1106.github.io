<div class="row">
	<div class="panel panel-info">
	  <div class="panel-heading">
	    <h3 class="panel-title text-center"><img src="<?php echo base_url(); ?>upload/icon/new.gif" alt=""><a href="<?php echo base_url('/product/new'); ?>" class='product_title'>Sản phẩm mới </a><img src="<?php echo base_url(); ?>upload/icon/new.gif" alt=""></h3>
	  </div>
...
<div class="row">
	<div class="panel panel-info">
	  <div class="panel-heading">
	    <h3 class="panel-title text-center"><img src="<?php echo base_url(); ?>upload/icon/hot.gif" alt=""><a href="<?php echo base_url('/product/hot'); ?>" class='product_title'>Sản phẩm bán chạy</a><img src="<?php echo base_url(); ?>upload/icon/hot.gif" alt=""></h3>
	  </div>
	  <div class="panel-body">
	  	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearpadding">
